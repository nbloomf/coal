...
Let's embed some Google Spreadsheets! Note that these embedded spreadsheets are \textbf{Read Only}; this is a limitation of Google spreadsheets (as far as I can tell). However, they do update live -- or with a few minutes' delay -- so you can edit the master spreadsheet and any embedded copies will reflect the changes. That's nifty!
